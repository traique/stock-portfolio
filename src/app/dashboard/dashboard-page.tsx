...
import {
  calcCashSummary, calcPosition, formatCurrency,
  CashTransaction, derivePortfolio,
  PositionGroup, PortfolioSettings, PriceMap, Transaction,
} from '@/lib/calculations';
import { supabase } from '@/lib/supabase';
import {
  getAiPortfolioKey, AllocationItem, AiPortfolioResponse, CashSummaryShape,
...
export default function DashboardPage() {
  ...
  const [alertSettings,  setAlertSettings]  = useState<AllocationAlertSettings>({ warningPct: 25, dangerPct: 40 });
  ...
  // =========================================================
  // DERIVED — simulateTransactions chỉ chạy 1 lần qua derivePortfolio
  // =========================================================
  ...
  // Cảnh báo tỷ trọng — chạy mỗi khi positions/prices/totalAssets/settings thay đổi
  ...
  return (
    <main className="ab-page">
      <div className="ab-shell" style={{ gap: 12 }}>
        ...
        {/* ── Nút Export ── */}
        {!loading && (positions.length > 0 || enrichedTxs.length > 0) && (
