...
//
// Client wrapper nhận dữ liệu đã được Server Component (page.tsx) prefetch.
// Toàn bộ tương tác (forms, refresh, AI, export) vẫn chạy như cũ qua
// usePortfolio — chỉ phần tải dữ liệu ban đầu được chuyển lên server.
...
import type { CashSummaryShape, DashboardInitialData } from '@/lib/dashboard-types';
