  ...
  return (
    <div style={{ padding: 14, border: '1px solid var(--border)', borderRadius: 16, background: 'var(--soft)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8 }}>
        {[
          { label: 'ENTRY', value: pick.entry, style: { background: 'var(--card)',         border: '1px solid var(--border)',       color: 'var(--text)'  } },
          { label: 'TP',    value: pick.tp,    style: { background: 'var(--green-surface)', border: '1px solid var(--green-border)', color: 'var(--green)' } },
          { label: 'SL',    value: pick.sl,    style: { background: 'var(--red-surface)',   border: '1px solid var(--red-border)',   color: 'var(--red)'   } },
        ].map(({ label, value, style }) => (
          <div key={label} style={{ padding: '6px 0', borderRadius: 10, textAlign: 'center', ...style }}>
