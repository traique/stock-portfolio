...
// Use userId as localStorage key — avoids AI result leakage between accounts on shared devices
...
export default function HomePage() {
  ...
  // Restore AI cache — only after userId is known to avoid cross-account reads
  useEffect(() => {
    if (!userId) return;
    ...
    <main className="ab-page">
      <div className="ab-shell">
        ...
        <AppShellHeader
          ...
          currentTab="home"
          onLogout={async () => {
            localStorage.removeItem(getAiWatchlistKey(userId));
