...
// Key phải khớp với app-shell-header.tsx ('lcta_theme')
const themeInitScript = `
(function () {
  try {
    var stored = localStorage.getItem('lcta_theme');
...
export default function RootLayout({
  ...
  return (
    <html
      ...
      // Font variable class phải nằm trên <html> (không phải <body>): các token
      // --font-main/--font-number được ghép từ var(--font-sans)/... tại scope :root,
      // đặt trên body sẽ khiến :root nhìn thấy biến rỗng → toàn app rơi về font mặc định.
