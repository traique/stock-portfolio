    ...
    <article style={QUOTE_ARTICLE_STYLE}>
      <div className="ab-row-between align-start" style={{ marginBottom: 12 }}>
        <div>
          ...
          <div style={{ fontSize: 10, fontWeight: 800, color: 'var(--subtle)', marginTop: 4, letterSpacing: '0.05em' }}>
            CỔ PHIẾU
          </div>
        </div>
        <button
  ...
  return (
    <main className="ab-page">
      <div className="ab-shell">
        ...
        {/* --- VN-INDEX OVERVIEW --- */}
        <section className="ab-premium-card ab-vnindex-overview" style={{ display: 'flex', flexWrap: 'wrap', gap: 16, alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            <span style={{ fontSize: 12, fontWeight: 800, color: 'var(--subtle)', display: 'flex', alignItems: 'center', gap: 6, letterSpacing: '0.05em' }}>
          ...
          <div className="ab-vnindex-stats" style={{ display: 'flex', gap: 32 }}>
            {[
              ...
              <div key={stat.label} style={{ textAlign: 'center' }}>
                <span style={{ fontSize: 12, fontWeight: 700, color: 'var(--subtle)' }}>{stat.label}</span>
