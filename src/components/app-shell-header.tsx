                    ...
                    {modelsLoading ? (
                      ...
                      [1, 2, 3].map(i => (
                        <div key={i} style={{
                          ...
                          background: 'var(--soft)', animation: 'pulse 1.5s infinite',
                        }} />
                      ))
                    ) : aiModels.length === 0 ? (
                        ...
                        return (
                          ...
                          >
                            <div style={{ minWidth: 0 }}>
                              <div style={{ fontSize: 12, fontWeight: 800, color: 'var(--text)', display: 'flex', alignItems: 'center', gap: 5 }}>
                                {m.label}
                                <span style={{
                                  fontSize: 9, fontWeight: 800, padding: '1px 5px',
                                  borderRadius: 99,
                                  background: m.provider === 'gemini' ? 'rgba(59,130,246,0.15)' : 'rgba(16,185,129,0.15)',
                                  color:      m.provider === 'gemini' ? '#3b82f6' : '#10b981',
                                }}>
                                  {m.badge}
                                </span>
                              </div>
