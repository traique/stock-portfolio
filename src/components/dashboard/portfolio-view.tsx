...
const colorFor  = (v?: number | null): string =>
  !Number.isFinite(v as number) ? C_MUTED : (v as number) > 0 ? C_GREEN : (v as number) < 0 ? C_RED : C_MUTED;
      ...
      <section style={{ ...CARD, padding: 16 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: 10, alignItems: 'center', flexWrap: 'wrap', marginBottom: 16 }}>
          ...
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
            ...
            <button
              type="button"
              style={{ ...PILL, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6 }}
              ...
              return (
                <article key={pos.symbol} style={{ ...STRONG_CARD, padding: 16, borderRadius: 20, display: 'flex', flexDirection: 'column', gap: 14, boxShadow: 'none' }}>
                  ...
                  <div style={{ display: 'grid', gap: 10, gridTemplateColumns: '1fr auto', alignItems: 'end' }}>
                    ...
                    <div style={{
                      borderRadius: 16, padding: '12px 16px', minWidth: 120, textAlign: 'right',
                      background: positive ? 'rgba(16,185,129,0.10)' : 'rgba(244,63,94,0.10)',
                      border:     `1px solid ${positive ? 'rgba(16,185,129,0.20)' : 'rgba(244,63,94,0.20)'}`,
                  ...
                  <button
                    ...
                    style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 14, padding: 12, cursor: 'pointer', color: C_TEXT, fontSize: 12, fontWeight: 800, letterSpacing: '0.04em', width: '100%' }}
                  >
