...
// ⚠️ Import sector data từ '@/lib/sector-map' (client-safe, thuần data) — KHÔNG
// import './sector-analyzer': module đó kéo theo providers/vci-chart (fetch DNSE)
// và làm bung server code vào client bundle khi dashboard import hàm này.
import { getSymbolSectors, SECTOR_MAP } from '@/lib/sector-map';
